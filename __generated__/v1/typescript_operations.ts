...
export type Shared_LangFragment = (
  { __typename?: 'Continent' }
  & Pick<Continent, 'name'>
);

export type Shared_CountryFragment = (
  { __typename?: 'Country' }
...
export type CountryQuery = (
  ...
  & { country?: Maybe<(
    { __typename?: 'Country' }
    & Pick<Country, 'name' | 'phone' | 'currency'>
  )> }
);

export const Shared_LangFragmentDoc = gql`
    fragment Shared_Lang on Continent {
  name
}
    `;
export const Shared_CountryFragmentDoc = gql`
...
export const CountriesDocument = gql`
  ...
  continents {
    ...
    ${Shared_CountryFragmentDoc}
${Shared_LangFragmentDoc}`;
